      ...
      <Container>
        <div className="">
          ...
          <div className="flex items-center py-4">
            ...
            <IoIosArrowForward />
            <h2 className="font-sans font-normal text-[12px] text-[#767676] ">
              <Link to="/contact" className='font-bold text-black'>Contacts</Link>
            </h2>
          </div>
        </div>
        <div className="w-1/2">
       ...
       <h3 className="font-sans font-bold text-[39px] text-[#262626] pb-[40px]">
        ...
        <div className="pt-[120px]">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.1467488049316!2d90.3798147743258!3d23.742145789095115!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b9b067dbaf61%3A0x75c5b9a41c0b3c4a!2sCreative%20IT%20Institute%20(Campus%202)!5e0!3m2!1sen!2sbd!4v1726727168636!5m2!1sen!2sbd"  width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </Container>
    </section>
